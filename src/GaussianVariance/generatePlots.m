function generatePlots(data, mcmcSamples, truePDF, meanPrior, initGuess)
    ...
    %%%%%%%%%%%%%%%%%%% Checking the mean %%%%%%%%%%%%%%%%%%%
    noData = size(data, 1);
    postMean = (meanPrior.precision + noData * truePDF.precision) \ ...
                (meanPrior.precision * meanPrior.mean' +  ...
    ...
    postVariance = inv(meanPrior.precision + noData * truePDF.precision);
